...
class H2Chp1(Component):
    ...
    def create_oemof_model(self, busses, model):
        ...
        h2_chp_1_electric = solph.custom.PiecewiseLinearTransformer(
        ...
        h2_chp_1_thermal = solph.custom.PiecewiseLinearTransformer(
        ...
        model.add(h2_chp_1_electric, h2_chp_1_thermal)

        self.model_el = h2_chp_1_electric
        self.model_th = h2_chp_1_thermal
    ...
    def update_constraints(self, busses, model_to_solve):
        ...
        def h2_chp_1_ratio_rule(model, t):
            # Inverter flow
            expr = 0
        ...
        model_to_solve.h2_chp_1_flow_ratio_fix = po.Constraint(
            model_to_solve.TIMESTEPS, rule=h2_chp_1_ratio_rule)
