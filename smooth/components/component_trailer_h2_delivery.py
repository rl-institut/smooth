...
class TrailerH2Delivery(Component):
    ...
    def update_var_costs(self, results, sim_params):
        ...
        if self.variable_costs is not None:
            ...
            self.results['variable_costs'][sim_params.i_interval] = flow_switch_value * \
                self.round_trip_distance * self.variable_costs
    ...
    def prepare_simulation(self, components):
        ...
        # low artificial costs (to encourage system to fill it)
        ...
        if self.fs_component_name is not None:
            ...
            fs_destination_available_storage = fs_origin_storage_capacity - fs_destination_storage_level_kg
