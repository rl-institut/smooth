...
#     THIS FUNCTION HAS BEEN TAKEN FROM oemof VERSION 0.4 constraints.py
#     https://github.com/oemof/oemof-solph/blob/dev/src/oemof/solph/constraints.py
#     (copied by timo.meyer@rl-institut.de)
